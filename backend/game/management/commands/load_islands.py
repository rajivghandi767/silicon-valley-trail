    ...
    def handle(self, *args, **options):
        ...
        stops_along_journey = [
            ...
            },
            {
                ...
                "reward_resource": "cash",
                "reward_amount": 300,
                "reward_message": "You consulted for an AI startup registering a local domain. Easy money! (+$300)",
            },
            {
                "name": "St. Eustatius",
                "latitude": 17.4890,
                ...
                "reward_resource": "cash",
                "reward_amount": 200,
                "reward_message": "Tapping into the island's free-trade history, you flipped some crypto on a decentralized exchange. (+$200)",
            },
            {
                "name": "St. Barts 🇧🇱",
                "latitude": 17.9000,
            ...
            },
            {
                ...
                "latitude": 15.4150,
                "longitude": -61.3710,
                "description": "The Nature Island! Find the REACH Program Director at the hiking festival and execute the pitch flawlessly.",
                "reward_resource": "morale",
                "reward_amount": 20,
