...
class GameMechanicsTests(TestCase):
    def setUp(self) -> None:
        ...
        self.game = CacheGameState(
            current_location_id=1, cash=2500, award_miles=8000, morale=100, bugs=0, days_remaining=18
        )
    ...
    def test_successful_flight_with_mocked_api(self, mock_choices, mock_weather) -> None:
        ...
        mock_choices.return_value = [
            {"impacts": {"cash": 500}, "text": "Mocked Event"}]
